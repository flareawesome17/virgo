...
export default function VirgoUsersPage() {
  ...
  return (
    <>
      <PageHeader
        ...
        description={
          data
            ? `${data.total} accounts on the platform`
            : 'Everyone with a Virgo account. Not console access — see Users for that.'
        }
      />
